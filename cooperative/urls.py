...
urlpatterns = [
    ...
    path('loan/validate/$', views.validate_loan, name='validate_loan'),
    path('investment/validate/$', views.validate_investment, name='validate_investment'),
    path('membership-request/$', views.react_to_membership_request, name='react_request'),
