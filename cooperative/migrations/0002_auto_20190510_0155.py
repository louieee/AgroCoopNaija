    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Committee Member', 'Committee Member'), ('Member', 'Member')], default='Member', max_length=10)),
        ...
        migrations.AddField(
            ...
            name='cooperative',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='cooperative.Cooperative'),
        ),
        migrations.AddField(
            model_name='investment',
            name='investor',
